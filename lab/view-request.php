...
<div class="card-body">
                ...
                <div>
                    ...
                    <input type="submit" name="topending" id="topending" class="btn btn-warning" value="Add to Pendings" >
                    <!-- <a href="view-results.php" class="btn btn-warning">Add to Pending</a> -->
                    </div>
            </div>
</form>
        </div>
...
<?php
if(isset($_POST['topending'])){
$upadte=mysqli_query($con,"UPDATE orders SET status='Pending' where order_id='$order_id'");
}
